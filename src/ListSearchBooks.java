    ...
    private void setupColumnWidths() {
        for (int i = 0; i < 13; i++) {
            ...
            switch (i) {
                ...
                case 5 -> column.setPreferredWidth(40);   // Copyright
                case 6 -> column.setPreferredWidth(40);   // Edition
                case 7 -> column.setPreferredWidth(40);   // Pages
                case 8 -> column.setPreferredWidth(80);   // NumberOfBooks
                case 9 -> column.setPreferredWidth(70);   // ISBN
                case 10 -> column.setPreferredWidth(30);  // Library
                case 11 -> column.setPreferredWidth(30);  // Available
                case 12 -> column.setPreferredWidth(30);  // ShelfNo
            }
        }
    }
